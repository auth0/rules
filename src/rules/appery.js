...
function (user, context, callback) {
  ...
  const APPERYIO_DATABASE_ID = '<APPERYIO_DATABASE_ID>';
  const PASSWORD_SECRET = 'A REALLY LONG PASSWORD';         // you can use this to generate one http://www.random.org/strings/
