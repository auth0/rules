...
The way you ask for a `refresh_token` is by sending the `access_type=offline` as an extra parameter as [explained here](https://docs.auth0.com/login-widget2#6).
